...
public class C01_PassbyValue {
    ...
    public static double yuzde10IndirimYap(double ucret){
        ...
        return ucret; // buraya fiyat degerinin variable i degil degeri gönderiliyor
        // return edilirken de uv´cret in degeri maine gönderiliyor
        // bu nedenle variable isimlerinin önemi yok
    }

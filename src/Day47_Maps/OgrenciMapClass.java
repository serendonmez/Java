...
public class OgrenciMapClass {
    ...
    public static void mapeOgrenciEkle(){
        ...
        ogrenciMap.put(106,"Sevgi-Can-9-K-MF");
        ogrenciMap.put(107,"Esra-Han-12-M-SOZ");
    }
    ...
    public static void ogrencininNumarasinaGoreListeYazdir(int enKucukOgrNo, int enBuyukOgrNo ){
    ...
    public static void bolumdekiOgrencilerListesiYazdir(String bolum) {
    ...
    public static void NumaraIleSoyIsimUpdate(int ogrenciNo, String yeniSoyisim){
        ...
        String yeniValue = join("-",valueArr); // "Ali-Yilmaz-11-K-TM"
    ...
    public static void sinifArtir(){
        ...
        for (Integer eachKey : keySeti
            ...
            String yeniValue = join("-",valueArr);
